package com.cts.learning.poDownload.kafka.config;
...
public class KafkaConsumerConfig {
	...
	public Map<String,Object> configMap(){
        ...
        amap.put(ConsumerConfig.GROUP_ID_CONFIG,"truck-sch");
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PO> kafkaListenerContainerFactory(){
        ConcurrentKafkaListenerContainerFactory<String, PO> factory = new ConcurrentKafkaListenerContainerFactory<>();
